...
public class ThirdPersonController : MonoBehaviour
{
    ...
    void WeaponControl()
    {
        ...
        {
            IsArmed = false;
            SetNotArmedCameraParameters();
        }
        else
        {
            IsArmed = true;
            SetArmedCameraParameters();
        }

        //Clamp Weapon ID
        WeaponID = Mathf.Clamp(WeaponID, -1, Weapons.Length);
    }
    void SetArmedCameraParameters()
    {
        MyPivotCamera.TargetHeight = 0.4f;
        MyPivotCamera.X_adjust = 0.32f;
        MyPivotCamera.Y_adjust = -0.158f;
    }
    void SetNotArmedCameraParameters()
    {
        MyPivotCamera.TargetHeight = 0f;
        MyPivotCamera.X_adjust = 0f;
        MyPivotCamera.Y_adjust = -0.355f;
    }
    void PickUpWeapons()
    {
