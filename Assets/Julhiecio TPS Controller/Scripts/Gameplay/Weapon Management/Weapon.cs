...
public class Weapon : MonoBehaviour
{
	...
	//技能服务接口
	public Sel.SkillSystem.IBulletServer bulletServer;
	...
	public void CheckAndGetBulletServer()
    {
		if(bulletServer == null || !bulletServer.IsOpen())
        {
			bulletServer = Sel.SkillSystem.SkillSystem.GetSkillServer();
		}
	}
	public void Shot()
	{
		...
		if (FireMode != Weapon.WeaponFireMode.Shotgun)
		{
			...
			bullet.GetComponent<Bullet>().ShotWeapon = this;

			//技能系统对此的影响
			CheckAndGetBulletServer();
			Sel.SkillSystem.IBulletSkill bulletSkill = bulletServer?.GetBulletSkill();
			bulletSkill?.RenderBullet(bullet.GetComponent<Bullet>());
